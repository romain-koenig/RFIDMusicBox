...
unsigned long uid = 0; //To store TAG UID
bool firstrun = true; //To have a different workflow on first run
...
// only run if a new card is there = run just once for one card until removed
